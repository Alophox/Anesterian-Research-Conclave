...
return {
	...
	weapon = {
		...
		damageData = {
			...
			damage = (weaponStats.damageMult[weaponConst.size] * weaponStats.laser.baseDMG / (weaponStats.laser.baseDuration / weaponStats.laser.secondsPerShot))/weaponStats.laser.instances/weaponStats.laser.shotsPerBurst[weaponConst.size],
		...
		--Visuals
		sizeInUnits = .6,         --Controls laser width, 
		...
		laserDescription = { 		--"laser" description, but is actually a maleable visual effect.
						duration = .2,			--seconds
						opacity = .3,			--float, 0-1
						diameter = 1.6,			--relative to turret scale
		...
		reloadAmount = 0,
		secondsPerCycle = (weaponStats.laser.baseCD*weaponStats.CDMult[weaponConst.size] + weaponStats.CDMod[weaponConst.size]) - weaponStats.laser.secondsPerShot*(weaponStats.laser.baseDuration / weaponStats.laser.secondsPerShot - 1),
		secondsPerCycleCurrent = 0,

		--Magazine Size
		shotsPerCycle = weaponStats.laser.shotsPerBurst[weaponConst.size] * weaponStats.laser.baseDuration / weaponStats.laser.secondsPerShot,
		shotsPerCycleCurrent = weaponStats.laser.shotsPerBurst[weaponConst.size] * weaponStats.laser.baseDuration / weaponStats.laser.secondsPerShot,
		simultaniousShots = weaponStats.laser.shotsPerBurst[weaponConst.size],

		--Fire Rate
		secondsPerShot = weaponStats.laser.secondsPerShot,
	...
	targeting = {
		acquisition = {
			...
			maximumDistance = weaponStats.fireRangeMult * weaponStats.rangeMult[weaponConst.size] * weaponStats.laser.baseRange, 			--Important. Scan radius. Don't target things further than this. KEEP THIS NUMBER LOW, SERIOUS PERFORMANCE IMPACT. Light ~15, Medium ~20, Heavy ~25, Capital ~25
		...
		tracking = {
			...
			invalidationDistance = weaponStats.fireRangeMult * weaponStats.rangeMult[weaponConst.size] * weaponStats.laser.baseRange,
