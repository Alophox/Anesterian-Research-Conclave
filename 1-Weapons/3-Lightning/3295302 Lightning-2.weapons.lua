...
return {
	...
	weapon = {
		...
		lockTime =  weaponStats.lightning.baseCD * weaponStats.CDMult[weaponConst.size] * weaponStats.lightning.lockTimeRatio,                 -- Seconds this weapon must have the same target before it can fire.
	...
	targeting = {
		acquisition = {
			...
			scoreForArmourCurrent = 2, 		--Good for anti-armour, if negative good for units with weapons that are better spent against raw hull.
