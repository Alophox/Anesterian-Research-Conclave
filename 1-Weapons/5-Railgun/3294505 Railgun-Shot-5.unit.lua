...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-railgun-shot",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Extra Large Plasma Railgun Shot",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	...
	-- picture                     = "329-railgun-shot.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	databankEntry               = {
		...
		weaponInfo                  = { 	-- int3 array: Tells the databank which weaponDatas to grab and display for this unit. Not automatic you have to do this, I'm sorry.
			{ 3296505, 1, 0 }   		-- (int, int, int): weaponID, count, subMunitionWeaponID (bullet, missile, etc, 0 = none) This gets the damage data of the subMunitionWeapon if it has any, important for bullets which themselves do damage via a subweapon.
		},
	...
	mainMesh                    	= "329-Turrets-1/Turret-1-Railgun-Effect",   -- string: Visual body of this unit. Requires materials to be visible. FileName/ObjectName, looks for FileName.glb and then ObjectName from within that.
	...
	materials                   = { "329_MT_arc_teamGlow", "329_MT_arc_weapon_teamGlow" },
	...
	data = {
		typeID       = 3294505, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
		{
			...
			weapon    = {
				weaponID = 3296505, --int: The weaponData id to be used for this weapon.
	...
	ghostMesh		= "329-Turrets-1/Turret-1-Railgun-Effect",   -- Used for build ghosts on spawners (yards).
	ghostMaterials                   = { "329_MT_arc_teamGlow", "329_MT_arc_weapon_teamGlow"   }, -- Used for the ghostMesh for build ghosts on spawners (yards).
	ghostParts 	= {
	},
	...
	health = {
		...
		lifetime = weaponStats.railgun.baseRange * weaponStats.overShootMult * weaponStats.rangeMult[weaponConst.size] / weaponStats.railgun.velocity,                         -- float: How long in seconds before this unit self-destructs. (drones, missiles, bullets)
	...
	movement           = {
		...
		maximumAngleToTargetDegrees = 0,        -- float: Radians within in which a unit is allowed to accelerate towards a target.
