...
function prefab.weapon.cannon_effect(diameter)
	return {
		name		 = "MuzzleFlash",
		mesh       = "329-Turrets-1/Muzzle-Flash",
		...
		weaponVisualConfig = { --Controls how the visual effect behaves.
			...
			laserDescription = {
				duration = .2,			--seconds
				opacity = .3,			--float, 0-1
				diameter = diameter*10,			--relative to turret scale
				...
				noRescaleLength = diameter,	--0 means DO rescale like a laser beam. >0 means don't, like a muzzle flashes.
		...
		prefab_part.parts={
			{
				...
				parts = {
					{	name = "Turret Muzzle",	position = { 0, 0, 0 },	rotation = { 0, 0, 0 },	scale = { 1, 1, 1 },	barrel = true,	},
					prefab.weapon.cannon_effect(1.6),
					prefab.weapon.cannon_effect(1.6),
					prefab.weapon.cannon_effect(1.6),
					prefab.weapon.cannon_effect(1.6),
					prefab.weapon.cannon_effect(1.6),
