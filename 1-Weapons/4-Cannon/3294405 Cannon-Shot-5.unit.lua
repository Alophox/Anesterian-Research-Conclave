...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-cannon-shot-5",                 -- string: Internal name for debugging and errors.
	...
	-- picture                     = "329-cannon-shot.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	databankEntry               = {
		...
		weaponInfo                  = { 	-- int3 array: Tells the databank which weaponDatas to grab and display for this unit. Not automatic you have to do this, I'm sorry.
			{ 3296405, 1, 0 }   		-- (int, int, int): weaponID, count, subMunitionWeaponID (bullet, missile, etc, 0 = none) This gets the damage data of the subMunitionWeapon if it has any, important for bullets which themselves do damage via a subweapon.
		},
	...
	mainMesh                    	= "329-Turrets-1/Turret-1-Cannon-Effect",   -- string: Visual body of this unit. Requires materials to be visible. FileName/ObjectName, looks for FileName.glb and then ObjectName from within that.
	...
	data = {
		typeID       = 3294405, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
		{
			...
			weapon    = {
				weaponID = 3296405, --int: The weaponData id to be used for this weapon.
	...
	ghostMesh		= "329-Turrets-1/Turret-1-Cannon-Effect",   -- Used for build ghosts on spawners (yards).
	...
	targetingData      = {
		acquisition = {
			...
			maximumDistance = weaponStats.fireRangeMult * weaponStats.rangeMult[weaponConst.size] * weaponStats.cannon.baseRange, 			-- float: Important. Scan radius. Don't target things further than this. KEEP THIS NUMBER LOW, SERIOUS PERFORMANCE IMPACT. Light ~15, Medium ~20, Heavy ~25, Capital ~25
			maximumAngleDegrees = 286.47889756541161, 				-- float: Good for spinal weapons/missiles.
	...
	payload = {
		damage = {
			...
			damage = 0,
			piercing = 0,        --Ignore this much armour. Negative applies Aegis shielding.
			...
			vulnerability = 0, --Negate this much armour.
