...
return {
	...
	data = {
		typeID       = 1014401, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
		{
			...
			weapon    = {
				weaponID = 1016401, --int: The weaponData id to be used for this weapon.
