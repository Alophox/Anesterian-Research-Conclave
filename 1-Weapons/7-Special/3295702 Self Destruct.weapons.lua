...
return {
	...
	weapon = {
		...
		selfDamage = 999999,          -- damage done to root unit per shot.
		selfHeat = 0,            -- heat done to root unit per shot.
		selfImpulseForce = 0,              -- Force applied opposite the firing direction.
		dontFireBelowHealthFraction = 0.01,   -- hold fire if parent health falls below this threshold
	...
	targeting = {
		acquisition = {
			...
			maximumDistance = .01, 			--Important. Scan radius. Don't target things further than this. KEEP THIS NUMBER LOW, SERIOUS PERFORMANCE IMPACT. Light ~15, Medium ~20, Heavy ~25, Capital ~25
