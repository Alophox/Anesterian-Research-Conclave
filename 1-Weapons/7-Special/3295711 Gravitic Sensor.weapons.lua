...
return {
	id = 3295711,
	name = "Gravitic Sensor Suite",
	blurb = "Reveals cloaked ships. Gravitic sensors cannot be fooled. They can, however, be inundated with junk data from dust and debris- limiting its effective range.",
	metaNote = "",
