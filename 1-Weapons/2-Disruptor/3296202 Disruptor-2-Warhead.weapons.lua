...
return {
     ...
     weapon = {
          ...
          damageData = {
               ...
               instances = weaponStats.disruptor.instances,                     -- int: How many times is this damage dealt. For making weapons worse against armour.
               damage = (weaponStats.damageMult[weaponConst.size] * weaponStats.disruptor.baseDMG / weaponStats.disruptor.instances)/weaponStats.disruptor.shotsPerBurst[weaponConst.size],                       -- float: Raw damage, reduced by armour.
               ...
               heat = (weaponStats.damageMult[weaponConst.size] * weaponStats.disruptor.baseHeat / weaponStats.disruptor.instances)/weaponStats.disruptor.shotsPerBurst[weaponConst.size],                          -- float: Apply this much heat. Health is heat capacity.
