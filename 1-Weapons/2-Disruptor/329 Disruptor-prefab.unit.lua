		...
		prefab_part.parts={
			{
				...
				parts = {
					...
					{
						name      = "Turret Barrel",
						mesh      = "329-Turrets-1/Turret-1-Disruptor", --The mesh to be used for this part, works the same as mainMesh.
		...
		prefab_part.parts={
			{
				...
				parts = {
					...
					{
						name      = "Turret Barrel",
						mesh      = "329-Turrets-3/Turret-3-Disruptor",
						materials = { "329_MT_arc_hull", "329_MT_arc_teamGlow" },
						position  = { .15, 0, 0 },
						rotation  = { 0, 0, 0 },
						scale 	= { 1, 1, 1 },
		...
		prefab_part.parts={
			{
				...
				parts = {
					...
					},
					{
						...
						mesh      = "329-Turrets-5/Turret-5-Disruptor",
						materials = { "329_MT_arc_hull", "329_MT_arc_teamGlow" },
						position  = { -.375, 0, 0 },
						rotation  = { 0, 0, 0 },
						scale 	= { 1, 1, 1 },
