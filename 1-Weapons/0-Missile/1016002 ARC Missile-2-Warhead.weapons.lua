return {
     ...
     weapon = {
          ...
          damageData = {
               ...
               impulseForce = 21                 -- float: Apply this much push force. This is reduced by target mass like normal physics.
          },
     ...
     targeting = {
          acquisition = {
               ...
               secondsPerScan = 1.0, 			--How long to wait before reassessing what you're targeting.
