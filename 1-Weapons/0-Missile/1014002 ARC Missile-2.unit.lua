...
return {
	...
	materials                   = { "arc_hull","arc_teamColour","arc_teamGlow","arc_hull_dark","arc_teamGlow" },
	...
	data = {
		typeID       = 3294002, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	health = {
		...
		deathUnitSpawnTypeID = 3294012,            	-- int: The unit spawned when this dies. -1 is nothing. Used for debris, and Glowfish Blobs.
