...
return {
	...
	mainMesh                    	= "Missiles/Missile-1-Zerda",   -- string: Visual body of this unit. Requires materials to be visible. FileName/ObjectName, looks for FileName.glb and then ObjectName from within that.
	...
	data = {
		typeID       = 1014002, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
		{
			...
			weapon    = {
				weaponID = 1016002, --int: The weaponData id to be used for this weapon.
	...
	targetingData      = {
		acquisition = {
			...
			classMultHeavy = 0.7,	-- float: 
			classMultCapital = 0.5,	-- float: 
			classMultTitan = 0.2,	-- float: 
