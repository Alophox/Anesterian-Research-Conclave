...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-macrotis",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Macrotis",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	...
	-- picture                     = "329-macrotis.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	movement           = {
		...
		maximumAngleToTargetDegrees = 34.377467707849391,        -- float: Radians within in which a unit is allowed to accelerate towards a target.
