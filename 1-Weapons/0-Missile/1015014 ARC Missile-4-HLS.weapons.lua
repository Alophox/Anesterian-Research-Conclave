...
return {
	id = 3295014,
	name = "Extra Large Missile HLS",
	blurb = "Extra Large Horizontal Launch System.",
	...
	weapon = {
		...
		relativeLaunchVelocity = { 0, 2, 0 }, -- add to unitsPerSecond to get velocity
