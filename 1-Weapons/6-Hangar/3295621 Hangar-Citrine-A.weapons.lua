return {
     id = 3295621,
     name = "Citrine-A Hangar",
     blurb = "Plasma Railgun Frigate",
     ...
     weapon = {
          ...
          secondsPerCycle = weaponStats.hangar.CD.citrine,        --Seconds per reload. Negative value prevent reloading (limited ammo weapons).
          ...
          secondsPerShotCurrent = weaponStats.hangar.secondsPerShot * 3 * 2,    --Starting delay.
