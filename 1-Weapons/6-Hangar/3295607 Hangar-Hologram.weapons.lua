return {
     id = 3295607,
     name = "Hologram Spawner",
     blurb = "Distraction.",
     metaNote = "Used on Courier",
     ...
     weapon = {
          ...
          simultaniousObjectLimit = weaponStats.hangar.instances,  -- LAUNCHER, used for Drones, mines, etc. 0 = no limit.
     ...
     targeting = {
          acquisition = {
               ...
               scoreForHealthCurrentMissing = .01, 	--Good for healers. 1 missing hp = 1 score.
               scoreForHealthCurrentPercentage = 1, --Good for healers, good for spreading healing between units regardless of total health.
               scoreForArmour = 1,      		--Good for anti-armour, if negative good for units with weapons that are better against raw hull. But can be misleading on it's own (*cough cough* GLADIATOR)
