return {
     id = 3295611,
     name = "Ruby-B Hangar",
     blurb = "Neutron Launcher Corvette",
     ...
     weapon = {
          ...
          secondsPerCycle = weaponStats.hangar.CD.ruby,        --Seconds per reload. Negative value prevent reloading (limited ammo weapons).
          ...
          secondsPerShotCurrent = weaponStats.hangar.secondsPerShot * 2 * 2,    --Starting delay.
