...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_sapphire-aaa",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_sapphire-aaa.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	-- BODY SETUP
	scale = scaleConst,
	-- mainMesh                    	= "3-Sapphire/Sapphire-Core-A",   -- string: Visual body of this unit. Requires materials to be visible. FileName/ObjectName, looks for FileName.glb and then ObjectName from within that.
	...
	parts = {
		...
		prefab.ship.sapphire.stern.A(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.sapphire.core.A(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.sapphire.bow.A(scaleConst, true, 0, "arc_aegis"),
	},
	...
	-- ghostMesh		= "1-Ruby/Ruby-Core-A",   -- Used for build ghosts on spawners (yards).
	...
	health = {
		...
		health = (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.A,healthStats.healthMult.A,healthStats.healthMult.A}),
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.A,healthStats.healthMult.A,healthStats.healthMult.A}), 			-- float: Game will automatically determine, but can be manually set here.
	...
	movement           = {
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["L"] * weaponStats.railgun.baseRange-3,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["L"] * weaponStats.railgun.baseRange-6,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
