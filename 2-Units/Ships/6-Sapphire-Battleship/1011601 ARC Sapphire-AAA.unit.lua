...
return {
	...
	movement           = {
		...
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["L"] * weaponStats.railgun.baseRange-5,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
