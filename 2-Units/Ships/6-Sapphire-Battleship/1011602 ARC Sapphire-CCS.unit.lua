...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329_MT_arc_sapphire-ccs",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "329_MT_arc_sapphire-ccs.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	-- BODY SETUP
	scale = scaleConst,
	-- mainMesh                    	= "3-Sapphire/Sapphire-Core-C",   -- string: Visual body of this unit. Requires materials to be visible. FileName/ObjectName, looks for FileName.glb and then ObjectName from within that.
	...
	-- ghostMesh		= "1-Ruby/Ruby-Core-C",   -- Used for build ghosts on spawners (yards).
	...
	health = {
		...
		health = (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.C,healthStats.healthMult.C,healthStats.healthMult.S}),
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.C,healthStats.healthMult.C,healthStats.healthMult.S}), 			-- float: Game will automatically determine, but can be manually set here.
