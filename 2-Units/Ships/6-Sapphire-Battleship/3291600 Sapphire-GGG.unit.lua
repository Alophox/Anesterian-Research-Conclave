...
return {
	...
	parts = {
		...
		prefab.ship.sapphire.stern.G(scaleConst,true, 0, "aegis"),
		prefab.ship.sapphire.core.G(scaleConst,true, 0, "aegis"),
		prefab.ship.sapphire.bow.G(scaleConst,true, 0, "aegis"),
	},
