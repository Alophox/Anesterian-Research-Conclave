...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-sapphire-ggg",                 -- string: Internal name for debugging and errors.
	...
	-- picture                     = "329-sapphire-ggg.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.sapphire.stern.G(scaleConst,true, 0, "aegis_teamColour"),
		prefab.ship.sapphire.core.G(scaleConst,true, 0, "aegis_teamColour"),
		prefab.ship.sapphire.bow.G(scaleConst,true, 0, "aegis_teamColour"),
	},
	...
	health = {
		...
		health = math.floor((1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.G,healthStats.healthMult.G,healthStats.healthMult.G})),
		health_regen_per_second = 0,
		aegisMaximum = functions.ceil(healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.G,healthStats.healthMult.G,healthStats.healthMult.G})), 			-- float: Game will automatically determine, but can be manually set here.
		aegis_regen_per_second = healthStats.aegisRegen[shipConst.class],
		max_regen_frac = healthStats.proportionRegenMax,

		armour = math.floor(healthStats.baseArmor[shipConst.class] * functions.averageMultiplier({healthStats.armorMult.G,healthStats.armorMult.G,healthStats.armorMult.G})),
		vulnerability_max = 0,
		shredMultiplier = 0,
