...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_citrine-c",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_citrine-c.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	-- mainMesh                    	= "2-Citrine/Citrine-Core-C",   -- string: Visual body of this unit. Requires materials to be visible. FileName/ObjectName, looks for FileName.glb and then ObjectName from within that.
	...
	parts = {
		...
		prefab.ship.citrine.core.C(scaleConst, true, 0, "arc_aegis"),
	},
	...
	-- ghostMesh		= "2-Citrine/Citrine-Core-C",   -- Used for build ghosts on spawners (yards).
	...
	health = {
		...
		health = (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.C}),
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.C}), 			-- float: Game will automatically determine, but can be manually set here.
	...
	movement           = {
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["S"] * weaponStats.hangar.baseRange-3,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["S"] * weaponStats.hangar.baseRange-4,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
