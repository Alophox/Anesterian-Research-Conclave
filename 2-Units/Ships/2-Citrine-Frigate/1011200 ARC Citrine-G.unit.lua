...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_citrine-g",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_citrine-g.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.citrine.core.G(scaleConst, true, 0, "arc_aegis"),
	...
	health = {
		...
		health = (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.G}),
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.G}), 			-- float: Game will automatically determine, but can be manually set here.
	...
	movement           = {
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["S"] * weaponStats.lightning.baseRange-1,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
