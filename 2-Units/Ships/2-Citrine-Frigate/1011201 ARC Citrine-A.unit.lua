...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_citrine-a",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_citrine-a.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	-- mainMesh                    	= "2-Citrine/Citrine-Core-A",   -- string: Visual body of this unit. Requires materials to be visible. FileName/ObjectName, looks for FileName.glb and then ObjectName from within that.
	...
	-- materials                   = { "arc_teamGlow", "arc_hull", "arc_hull_dark", "arc_engine", "arc_teamColour" },
	...
	-- ghostMesh		= "2-Citrine/Citrine-Core-A",   -- Used for build ghosts on spawners (yards).
	...
	health = {
		...
		health = (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.A}),
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.A}), 			-- float: Game will automatically determine, but can be manually set here.
