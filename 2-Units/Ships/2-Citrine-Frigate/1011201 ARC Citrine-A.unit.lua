...
return {
	...
	movement           = {
		...
		acceleration = 0.27,               -- float: The units per second of the ship's acceleration. A tolly is 0.4 units long, and accelerates at 0.35
		...
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["M"] * weaponStats.railgun.baseRange-2,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
