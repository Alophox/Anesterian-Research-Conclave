...
return {
	...
	movement           = {
		...
		standoffDistance = math.floor(.5+weaponStats.fireRangeMult * weaponStats.rangeMult.D * weaponStats.laser.baseRange-1),              -- float: How far away from a target's ColliderDimensions should a unit hold position?
		retreatDistance = math.floor(.5+weaponStats.fireRangeMult * weaponStats.rangeMult.D * weaponStats.laser.baseRange-2),               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
