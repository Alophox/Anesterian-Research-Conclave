...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-stardust",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Stardust Nanites",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	unitTooltip                 = "", 						   -- string: Shown when moused over in the HUD.
	unitBlurb                   = "Repair Nanites", -- string: Shown just below the unit name in tooltips and databank.
	...
	databankEntry               = {
		...
		tactical                    = 	"<color=yellow>Hull Repair Shielding Nanites</color>\n"..
										" - Untargetable\n"..
										" - Vulnerable to AOE\n"..
										" - Repairs Health\n"..
										" - Gives Aegis\n"..
	...
	data = {
		typeID       = 3291006, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
...

		{
			...
			rotate = {
				...
				degreeRotationPerSecond = { 120,0,0 }, -- decimals (x,y,z)
			},
			parts={
				{
		...
		prefab.weapon.special.stardust_repair(
			{ 0, 0, 0 }, -- position
			{ 0, 0, 0 }, -- rotation
			{ 1, 1, 1 }, -- scale
			false -- isGhost
