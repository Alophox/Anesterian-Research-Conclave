...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-hologram",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Hologram Drone",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	unitTooltip                 = "", 						   -- string: Shown when moused over in the HUD.
	unitBlurb                   = "EW Drone", -- string: Shown just below the unit name in tooltips and databank.
	...
	-- picture                     = "329-stardust.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	data = {
		typeID       = 3291007, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
		{
			name = "Hologram Module",
			autoModule = {
				moduleTypeID = 3297101,            -- int
	...
	movement           = {
		...
		acceleration = weaponStats.hangar.velocity * 1,               -- float: The units per second of the ship's acceleration. A tolly is 0.4 units long, and accelerates at 0.35
		...
		standoffDistance = 10,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
		retreatDistance = 12,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
		strafeMargin = 1,                -- float: How far away from standoffDistance strafe thrust is allowed to start. Default = 1
	...
	targetingData      = {
		acquisition = {
			...
			classMultHeavy = .7,	-- float: 
			classMultCapital = .9,	-- float: 
