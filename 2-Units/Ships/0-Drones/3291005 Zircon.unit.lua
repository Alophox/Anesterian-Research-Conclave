...
return {
	...
	targetingData      = {
		...
		tracking = {
			positionPredictionType = "ACCELERATED", --Algorithm for predicting target position. NONE (lasers, most ships), SIMPLE (bad, nothing uses this), TRIGONOMETRIC (spinal ships, turrets, missiles)
