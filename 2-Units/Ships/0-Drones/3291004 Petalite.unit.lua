...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-petalite",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Petalite",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	unitTooltip                 = "", 						   -- string: Shown when moused over in the HUD.
	unitBlurb                   = "Interceptor Drone", -- string: Shown just below the unit name in tooltips and databank.
	...
	-- picture                     = "329-petalite.png",             -- string filename: The name of the image file in this folder to be used for this unit.
    ...
    unitMetaRole = {
        ...
        offenceRole = "DRONE, DRONE_ARMOURED, LIGHT_ARMOUR, MEDIUM_ARMOUR", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what adaptive AIs think this unit is good at attacking. Multiple roles may be assigned
        defenceResponse = "DRONE, DRONE_ARMOURED, LIGHT_ARMOUR, MEDIUM_ARMOUR", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what defenses adaptive AIs think they should counter this unit with. Multiple roles may be assigned
        offenceResponse = "DRONE, DRONE_ARMOURED, LIGHT_ARMOUR, MEDIUM_ARMOUR", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what ships adaptive AIs think they should counter this unit with. Multiple roles may be assigned
	...
	data = {
		typeID       = 3291004, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	movement           = {
		...
		standoffDistance = math.floor(.5+weaponStats.fireRangeMult * weaponStats.rangeMult.D * weaponStats.lightning.baseRange-1),              -- float: How far away from a target's ColliderDimensions should a unit hold position?
		retreatDistance = math.floor(.5+weaponStats.fireRangeMult * weaponStats.rangeMult.D * weaponStats.lightning.baseRange-2),               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
