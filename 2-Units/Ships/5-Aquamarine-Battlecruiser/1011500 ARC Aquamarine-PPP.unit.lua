...
return {
	...
	data = {
		typeID       = 1011500, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	ghostParts 	= {
		prefab.ship.aquamarine.stern.P(scaleConst, true),
		prefab.ship.aquamarine.core.P(scaleConst, true),
		prefab.ship.aquamarine.bow.P(scaleConst, true),
	},
