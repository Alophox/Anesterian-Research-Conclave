...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_aquamarine-ppp",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_aquamarine-ppp.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.aquamarine.stern.P(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.aquamarine.core.P(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.aquamarine.bow.P(scaleConst, true, 0, "arc_aegis"),
	},
