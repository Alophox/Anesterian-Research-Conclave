...
return {
	...
	parts = {
		...
		prefab.ship.aquamarine.stern.P(scaleConst,true, 0, "aegis"),
		prefab.ship.aquamarine.core.P(scaleConst,true, 0, "aegis"),
		prefab.ship.aquamarine.bow.P(scaleConst,true, 0, "aegis"),
	},
