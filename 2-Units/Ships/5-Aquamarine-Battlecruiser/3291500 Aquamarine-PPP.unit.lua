shipConst = {
	class="H",
	standoff=weaponStats.fireRangeMult * weaponStats.rangeMult["M"] * weaponStats.laser.baseRange-2,
	retreat=weaponStats.fireRangeMult * weaponStats.rangeMult["M"] * weaponStats.laser.baseRange-4,
}
scaleConst = 2.35;
return {
    isCloaking = false,
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-aquamarine-ppp",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Aquamarine-PPP",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	unitTooltip                 = "", 						   -- string: Shown when moused over in the HUD.
	unitBlurb                   = "Picket Battlecruiser", -- string: Shown just below the unit name in tooltips and databank.
	...
	hotkey                      = "2",                             -- Unity KeyCode: For buildbar. The hotkey for this unit.
	generatePicture = true;
	-- picture                     = "329-aquamarine-ppp.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	databankEntry               = {
		...
		weaponInfo                  = functions.combineWeaponInfo({
			prefab.weapon_info.aquamarine.stern.P(),
			prefab.weapon_info.aquamarine.core.P(),
			prefab.weapon_info.aquamarine.bow.P(),
		}),
    ...
    unitMetaRole = {
        ...
        offenceRole = "MISSILE, DRONE, LIGHT, MEDIUM", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what adaptive AIs think this unit is good at attacking. Multiple roles may be assigned
        defenceResponse = "MISSILE, DRONE, LIGHT, MEDIUM", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what defenses adaptive AIs think they should counter this unit with. Multiple roles may be assigned
        offenceResponse = "MISSILE, DRONE, LIGHT, MEDIUM", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what ships adaptive AIs think they should counter this unit with. Multiple roles may be assigned
	...
	-- BODY SETUP
	scale = scaleConst,
	-- mainMesh                    	= "3-Aquamarine/Aquamarine-Core-P",   -- string: Visual body of this unit. Requires materials to be visible. FileName/ObjectName, looks for FileName.glb and then ObjectName from within that.
	...
	data = {
		typeID       = 3291500, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
		...
		prefab.ship.aquamarine.stern.P(scaleConst, false),
		prefab.ship.aquamarine.core.P(scaleConst, false),
		prefab.ship.aquamarine.bow.P(scaleConst, false),
		prefab.ship.aquamarine.stern.P(scaleConst,true, 0, "aegis_teamColour"),
		prefab.ship.aquamarine.core.P(scaleConst,true, 0, "aegis_teamColour"),
		prefab.ship.aquamarine.bow.P(scaleConst,true, 0, "aegis_teamColour"),
	},
	...
	ghostParts 	= {
		...
		prefab.ship.aquamarine.bow.P(scaleConst, true, 2),
	},

	-- 🟦 HEALTH & ARMOR
	health = {
		unitClass = "HEAVY",       -- string enum: UNITCLASS: NONE, MISSILE, DRONE, LIGHT, MEDIUM, HEAVY, CAPITAL, TITAN
		health = math.floor((1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P})),
		health_regen_per_second = 0,
		aegisMaximum = functions.ceil(healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P})), 			-- float: Game will automatically determine, but can be manually set here.
		aegis_regen_per_second = healthStats.aegisRegen[shipConst.class],
		max_regen_frac = healthStats.proportionRegenMax,

		armour = math.floor(healthStats.baseArmor[shipConst.class] * functions.averageMultiplier({healthStats.armorMult.P,healthStats.armorMult.P,healthStats.armorMult.P})),
		vulnerability_max = 0,
		shredMultiplier = 0,
