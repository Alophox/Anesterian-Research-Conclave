...
return {
	...
	ghostParts 	= {
		prefab.ship.aquamarine.stern.M(scaleConst, true),
		prefab.ship.aquamarine.core.M(scaleConst, true),
		prefab.ship.aquamarine.bow.M(scaleConst, true),
	},

	-- 🟦 HEALTH & ARMOR
	health = {
		unitClass = "HEAVY",       -- string enum: UNITCLASS: NONE, MISSILE, DRONE, LIGHT, MEDIUM, HEAVY, CAPITAL, TITAN
		health = healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.M,healthStats.healthMult.M,healthStats.healthMult.M}),
