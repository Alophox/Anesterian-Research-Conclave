...
return {
	...
	health = {
		...
		health = functions.floor((1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.B,healthStats.healthMult.B,healthStats.healthMult.B})),
		...
		armour = functions.floor(healthStats.baseArmor[shipConst.class] * functions.averageMultiplier({healthStats.armorMult.B,healthStats.armorMult.B,healthStats.armorMult.B})),
		vulnerability_max = 0,
		shredMultiplier = 0,
