...
return {
	...
	parts = {
		...
		prefab.ship.aquamarine.stern.B(scaleConst,true, 0, "aegis"),
		prefab.ship.aquamarine.core.B(scaleConst,true, 0, "aegis"),
		prefab.ship.aquamarine.bow.B(scaleConst,true, 0, "aegis"),
	},
