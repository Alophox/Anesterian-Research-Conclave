...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_aquamarine-bbb",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_aquamarine-bbb.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.aquamarine.stern.B(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.aquamarine.core.B(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.aquamarine.bow.B(scaleConst, true, 0, "arc_aegis"),
	},
