...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_ruby-b",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_ruby-b.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.ruby.core.B(scaleConst, true, 0, "arc_aegis"),
