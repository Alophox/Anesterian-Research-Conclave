...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-courier",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Courier",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	unitTooltip                 = "", 						   -- string: Shown when moused over in the HUD.
	unitBlurb                   = "ECM Battleship", -- string: Shown just below the unit name in tooltips and databank.
	...
	databankEntry               = {
		...
		weaponInfo                  = functions.combineWeaponInfo({
			prefab.weapon_info.unique.courier.core()
		}),
	...
	data = {
		typeID       = 3291805, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
		...
		-- 	},
		-- },
		prefab.ship.unique.courier.core(shipConst.scaleConst, false),
		prefab.ship.unique.courier.core(shipConst.scaleConst,true, 0, "aegis_teamColour"),
	},
	...
	ghostParts 	= {
		prefab.ship.unique.courier.core(shipConst.scaleConst, true, 2),
	},
