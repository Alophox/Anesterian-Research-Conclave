...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-explorer",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Explorer",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	unitTooltip                 = "", 						   -- string: Shown when moused over in the HUD.
	unitBlurb                   = "Recon Cruiser", -- string: Shown just below the unit name in tooltips and databank.
	...
	databankEntry               = {
		...
		weaponInfo                  = functions.combineWeaponInfo({
			prefab.weapon_info.unique.explorer.core()
		}),
	...
	data = {
		typeID       = 3291803, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
		...
		prefab.ship.unique.explorer.core(shipConst.scaleConst, false),
		prefab.ship.unique.explorer.core(shipConst.scaleConst,true, 0, "aegis_teamColour"),
	},
	...
	ghostParts 	= {
		prefab.ship.unique.explorer.core(shipConst.scaleConst, true, 2),
	},
