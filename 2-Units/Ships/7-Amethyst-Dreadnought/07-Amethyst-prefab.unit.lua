	...
	prefab_part = {
		...
		parts={
				...
				parts={
			{
				...
				materials = isGhost and {ghostMat..ghostIndex,ghostMat..ghostIndex,ghostMat..ghostIndex,ghostMat..ghostIndex,ghostMat..ghostIndex,} or {"arc_hull_dark","arc_teamGlow", "arc_hull", "arc_teamColour", },
				position = {0,0,14.5},
				rotation = {0,90,0},
				scale = {1, 1, 1},
			},
