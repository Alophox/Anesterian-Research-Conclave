...
return {
	...
	ghostParts 	= {
		prefab.ship.amethyst.stern.P(scaleConst, true),
		prefab.ship.amethyst.core.P(scaleConst, true),
		prefab.ship.amethyst.bow.P(scaleConst, true),
	},

	-- 🟦 HEALTH & ARMOR
	health = {
		unitClass = "CAPITAL",       -- string enum: UNITCLASS: NONE, MISSILE, DRONE, LIGHT, MEDIUM, HEAVY, CAPITAL, TITAN
		health =  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P}),              -- float: Health, also the unit's heat capacity.
