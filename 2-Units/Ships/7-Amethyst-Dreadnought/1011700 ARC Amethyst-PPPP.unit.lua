...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_amethyst-pppp",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_amethyst-pppp.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.amethyst.stern.P(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.amethyst.core.P(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.amethyst.bow.P(scaleConst, true, 0, "arc_aegis"),
	},
