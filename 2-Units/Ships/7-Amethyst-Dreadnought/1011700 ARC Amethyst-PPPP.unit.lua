...
return {
	...
	health = {
		...
		health =  healthStats.baseHealth.C * functions.averageMultiplier({healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P}),              -- float: Health, also the unit's heat capacity.
		...
		armour = functions.floor(healthStats.baseArmor.C * functions.averageMultiplier({healthStats.armorMult.P,healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P})),
	...
	movement           = {
		...
		acceleration = 0.05 * functions.averageMultiplier({healthStats.accelMult.P,healthStats.accelMult.P,healthStats.accelMult.P,healthStats.accelMult.P}),               -- float: The units per second of the ship's acceleration. A tolly is 0.4 units long, and accelerates at 0.35
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["X"] * weaponStats.lightning.baseRange-5,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["L"] * weaponStats.lightning.baseRange,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
