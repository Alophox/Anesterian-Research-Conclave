...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329_MT_arc_amethyst-bbbb",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "329_MT_arc_amethyst-bbbb.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	health = {
		...
		health =  (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.B,healthStats.healthMult.B,healthStats.healthMult.B,healthStats.healthMult.B}),              -- float: Health, also the unit's heat capacity.
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.B,healthStats.healthMult.B,healthStats.healthMult.B,healthStats.healthMult.B}), 			-- float: Game will automatically determine, but can be manually set here.
