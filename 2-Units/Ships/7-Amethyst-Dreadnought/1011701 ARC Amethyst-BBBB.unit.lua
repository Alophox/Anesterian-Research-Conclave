...
return {
	...
	ghostParts 	= {
		prefab.ship.amethyst.stern.B(scaleConst, true),
		prefab.ship.amethyst.core.B(scaleConst, true),
		prefab.ship.amethyst.bow.B(scaleConst, true),
	},

	-- 🟦 HEALTH & ARMOR
	health = {
		unitClass = "CAPITAL",       -- string enum: UNITCLASS: NONE, MISSILE, DRONE, LIGHT, MEDIUM, HEAVY, CAPITAL, TITAN
		health =  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.B,healthStats.healthMult.B,healthStats.healthMult.B,healthStats.healthMult.B}),              -- float: Health, also the unit's heat capacity.
