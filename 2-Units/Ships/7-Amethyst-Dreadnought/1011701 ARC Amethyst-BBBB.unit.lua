...
return {
	...
	health = {
		...
		health =  healthStats.baseHealth.C * functions.averageMultiplier({healthStats.healthMult.B,healthStats.healthMult.B,healthStats.healthMult.B,healthStats.healthMult.B}),              -- float: Health, also the unit's heat capacity.
		...
		armour = functions.floor(healthStats.baseArmor.C * functions.averageMultiplier({healthStats.armorMult.B,healthStats.healthMult.B,healthStats.healthMult.B,healthStats.healthMult.B})),
	...
	movement           = {
		...
		acceleration = 0.05 * functions.averageMultiplier({healthStats.accelMult.B,healthStats.accelMult.B,healthStats.accelMult.B,healthStats.accelMult.B}),               -- float: The units per second of the ship's acceleration. A tolly is 0.4 units long, and accelerates at 0.35
