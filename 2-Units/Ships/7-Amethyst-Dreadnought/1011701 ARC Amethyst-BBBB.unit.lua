...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_amethyst-bbbb",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_amethyst-bbbb.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.amethyst.stern.B(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.amethyst.core.B(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.amethyst.bow.B(scaleConst, true, 0, "arc_aegis"),
	},
