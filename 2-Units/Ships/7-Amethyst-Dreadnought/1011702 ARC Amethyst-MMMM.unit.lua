...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_amethyst-mmmm",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_amethyst-mmmm.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.amethyst.stern.M(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.amethyst.core.M(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.amethyst.bow.M(scaleConst, true, 0, "arc_aegis"),
	},
