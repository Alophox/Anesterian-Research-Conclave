...
return {
	...
	health = {
		...
		health =  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.M,healthStats.healthMult.M,healthStats.healthMult.M,healthStats.healthMult.M}),              -- float: Health, also the unit's heat capacity.
