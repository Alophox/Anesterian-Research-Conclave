...
return {
	...
	health = {
		...
		health =  healthStats.baseHealth.C * functions.averageMultiplier({healthStats.healthMult.C,healthStats.healthMult.C,healthStats.healthMult.C,healthStats.healthMult.C}),              -- float: Health, also the unit's heat capacity.
		...
		armour = functions.floor(healthStats.baseArmor.C * functions.averageMultiplier({healthStats.armorMult.C,healthStats.healthMult.C,healthStats.healthMult.C,healthStats.healthMult.C})),
	...
	movement           = {
		...
		acceleration = 0.05 * functions.averageMultiplier({healthStats.accelMult.C,healthStats.accelMult.C,healthStats.accelMult.C,healthStats.accelMult.C}),               -- float: The units per second of the ship's acceleration. A tolly is 0.4 units long, and accelerates at 0.35
