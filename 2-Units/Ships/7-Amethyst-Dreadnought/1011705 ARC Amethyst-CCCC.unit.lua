...
return {
	...
	ghostParts 	= {
		prefab.ship.amethyst.stern.C(scaleConst, true),
		prefab.ship.amethyst.core.C(scaleConst, true),
		prefab.ship.amethyst.bow.C(scaleConst, true),
	},

	-- 🟦 HEALTH & ARMOR
	health = {
		unitClass = "CAPITAL",       -- string enum: UNITCLASS: NONE, MISSILE, DRONE, LIGHT, MEDIUM, HEAVY, CAPITAL, TITAN
		health =  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.C,healthStats.healthMult.C,healthStats.healthMult.C,healthStats.healthMult.C}),              -- float: Health, also the unit's heat capacity.
