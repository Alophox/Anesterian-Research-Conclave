...
return {
	...
	movement           = {
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["M"] * weaponStats.hangar.baseRange-1,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
