...
return {
    ...
    unitMetaRole = {
        ...
        offenceRole = {"DRONE","LIGHT","LIGHT_ARMOURED","LIGHT_STANDOFF","MEDIUM","MEDIUM_ARMOURED","MEDIUM_STANDOFF"}, -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what adaptive AIs think this unit is good at attacking. Multiple roles may be assigned
