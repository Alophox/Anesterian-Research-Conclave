...
return {
	...
	health = {
		...
		armour = functions.floor(healthStats.baseArmor[shipConst.class] * functions.averageMultiplier({healthStats.armorMult.C,healthStats.healthMult.C,healthStats.healthMult.C,healthStats.healthMult.C})),
