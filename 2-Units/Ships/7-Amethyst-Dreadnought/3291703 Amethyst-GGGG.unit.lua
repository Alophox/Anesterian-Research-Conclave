...
return {
	...
	parts = {
		...
		prefab.ship.amethyst.stern.G(scaleConst,true, 0, "aegis"),
		prefab.ship.amethyst.core.G(scaleConst,true, 0, "aegis"),
		prefab.ship.amethyst.bow.G(scaleConst,true, 0, "aegis"),
	},
	...
	health = {
		...
		health =  (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.G,healthStats.healthMult.G,healthStats.healthMult.G,healthStats.healthMult.G}),              -- float: Health, also the unit's heat capacity.
		...
		armour = functions.floor(healthStats.baseArmor[shipConst.class] * functions.averageMultiplier({healthStats.armorMult.G,healthStats.healthMult.G,healthStats.healthMult.G,healthStats.healthMult.G})),
	...
	movement           = {
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["X"] * weaponStats.lightning.baseRange-3,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["X"] * weaponStats.lightning.baseRange/2,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
