shipConst = {
	class="C",
	standoff=weaponStats.fireRangeMult * weaponStats.rangeMult["X"] * weaponStats.lightning.baseRange-3,
	retreat=weaponStats.fireRangeMult * weaponStats.rangeMult["X"] * weaponStats.lightning.baseRange/2,
}
...
return {
	...
	unitBlurb                   = "Gunship Dreadnought", -- string: Shown just below the unit name in tooltips and databank.
	...
	databankEntry               = {
		...
		weaponInfo                  = functions.combineWeaponInfo({
			prefab.weapon_info.amethyst.stern.G(),
			prefab.weapon_info.amethyst.core.G(),
			prefab.weapon_info.amethyst.bow.G(),
		}),
    ...
    unitMetaRole = {
        ...
        offenceRole = {"HEAVY_ARMOURED","CAPITAL_ARMOURED"}, -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what adaptive AIs think this unit is good at attacking. Multiple roles may be assigned
        defenceResponse = {"CAPITAL","CAPITAL_ARMOURED"}, -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what defenses adaptive AIs think they should counter this unit with. Multiple roles may be assigned
        offenceResponse = {"CAPITAL","CAPITAL_ARMOURED"}, -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what ships adaptive AIs think they should counter this unit with. Multiple roles may be assigned
	...
	data = {
		typeID       = 3291703, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
		...
		prefab.ship.amethyst.stern.G(scaleConst, false),
		prefab.ship.amethyst.core.G(scaleConst, false),
		prefab.ship.amethyst.bow.G(scaleConst, false),
		prefab.ship.amethyst.stern.G(scaleConst,true, 0, "aegis_teamColour"),
		prefab.ship.amethyst.core.G(scaleConst,true, 0, "aegis_teamColour"),
		prefab.ship.amethyst.bow.G(scaleConst,true, 0, "aegis_teamColour"),
	},
	...
	ghostParts 	= {
		prefab.ship.amethyst.stern.G(scaleConst, true, 2),
		prefab.ship.amethyst.core.G(scaleConst, true, 2),
		prefab.ship.amethyst.bow.G(scaleConst, true, 2),
	},
	...
	movement           = {
		...
		acceleration = healthStats.baseAccel[shipConst.class] * functions.averageMultiplier({healthStats.accelMult.G,healthStats.accelMult.G,healthStats.accelMult.G,healthStats.accelMult.G}),               -- float: The units per second of the ship's acceleration. A tolly is 0.4 units long, and accelerates at 0.35
		strafingAccelMultiplier = 0.8,     -- float: Fraction of accel used for strafing
		reverseAccelMultiplier = functions.averageMultiplier({healthStats.retreatMult.G,healthStats.retreatMult.G,healthStats.retreatMult.G,healthStats.retreatMult.G}),      -- float: Fraction of accel used for reverse/breaking
