...
return {
	...
	movement           = {
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["X"] * weaponStats.railgun.baseRange-4,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["X"] * weaponStats.railgun.baseRange-7,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
