...
return {
	...
	health = {
		...
		health =  healthStats.baseHealth.C * functions.averageMultiplier({healthStats.healthMult.G,healthStats.healthMult.G,healthStats.healthMult.G,healthStats.healthMult.G}),              -- float: Health, also the unit's heat capacity.
		...
		armour = functions.floor(healthStats.baseArmor.C * functions.averageMultiplier({healthStats.armorMult.G,healthStats.healthMult.G,healthStats.healthMult.G,healthStats.healthMult.G})),
	...
	movement           = {
		...
		acceleration = 0.05 * functions.averageMultiplier({healthStats.accelMult.G,healthStats.accelMult.G,healthStats.accelMult.G,healthStats.accelMult.G}),               -- float: The units per second of the ship's acceleration. A tolly is 0.4 units long, and accelerates at 0.35
