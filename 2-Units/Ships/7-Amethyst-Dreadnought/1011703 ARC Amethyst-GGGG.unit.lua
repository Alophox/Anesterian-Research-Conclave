...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_amethyst-gggg",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_amethyst-gggg.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.amethyst.stern.G(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.amethyst.core.G(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.amethyst.bow.G(scaleConst, true, 0, "arc_aegis"),
	},
