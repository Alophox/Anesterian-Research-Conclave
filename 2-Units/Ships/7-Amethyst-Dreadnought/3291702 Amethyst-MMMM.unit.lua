...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329_MT_arc_amethyst-mmmm",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "329_MT_arc_amethyst-mmmm.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.amethyst.stern.M(scaleConst,true, 0, "aegis"),
		prefab.ship.amethyst.core.M(scaleConst,true, 0, "aegis"),
		prefab.ship.amethyst.bow.M(scaleConst,true, 0, "aegis"),
	},
	...
	health = {
		...
		health =  (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.M,healthStats.healthMult.M,healthStats.healthMult.M,healthStats.healthMult.M}),              -- float: Health, also the unit's heat capacity.
		...
		armour = functions.floor(healthStats.baseArmor[shipConst.class] * functions.averageMultiplier({healthStats.armorMult.M,healthStats.healthMult.M,healthStats.healthMult.M,healthStats.healthMult.M})),
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.M,healthStats.healthMult.M,healthStats.healthMult.M,healthStats.healthMult.M}), 			-- float: Game will automatically determine, but can be manually set here.
	...
	movement           = {
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["X"] * weaponStats.missile.baseRange-3,
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["X"] * weaponStats.missile.baseRange-5,
