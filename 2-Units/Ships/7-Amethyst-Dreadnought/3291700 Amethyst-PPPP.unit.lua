...
return {
	...
	parts = {
		...
		prefab.ship.amethyst.stern.P(scaleConst,true, 0, "aegis"),
		prefab.ship.amethyst.core.P(scaleConst,true, 0, "aegis"),
		prefab.ship.amethyst.bow.P(scaleConst,true, 0, "aegis"),
	},
