...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329_MT_arc_amethyst-pppp",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "329_MT_arc_amethyst-pppp.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	health = {
		...
		health =  (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P}),              -- float: Health, also the unit's heat capacity.
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P}), 			-- float: Game will automatically determine, but can be manually set here.
