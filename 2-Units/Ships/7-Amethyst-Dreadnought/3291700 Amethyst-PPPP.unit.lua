...
return {
	...
	health = {
		...
		armour = functions.floor(healthStats.baseArmor[shipConst.class] * functions.averageMultiplier({healthStats.armorMult.P,healthStats.healthMult.P,healthStats.healthMult.P,healthStats.healthMult.P})),
