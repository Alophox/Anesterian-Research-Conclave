...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_amethyst-",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Amethyst-",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	...
	picture                     = "arc_amethyst-.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	databankEntry               = {
		...
		weaponInfo                  = 
			functions.combineWeaponInfo({ 	-- int3 array: Tells the databank which weaponDatas to grab and display for this unit. Not automatic you have to do this, I'm sorry.
			{
				prefab.weapon_info.laser.T(1),  		-- (int, int, int): weaponID, count, subMunitionWeaponID (bullet, missile, etc, 0 = none) This gets the damage data of the subMunitionWeapon if it has any, important for bullets which themselves do damage via a subweapon.
				prefab.weapon_info.cannon.L(4),
				prefab.weapon_info.lightning.L(4),
				prefab.weapon_info.railgun.L(4),
				prefab.weapon_info.laser.M(4),
				prefab.weapon_info.laser.S(4),
				prefab.weapon_info.hangar.quartz(16),
				prefab.weapon_info.hangar.ruby_m(2),
				prefab.weapon_info.missile.hls.L(12),
				prefab.weapon_info.missile.vls.L(36)
			}
		}),
	...
	colliderDimensions = {
		widthMultiplier  = 0.156,
		heightMultiplier = 0.143,
		lengthMultiplier = 1.0,
	},

	-- 🟦 UNIT ID, STRUCTURE COST, MACROTARGET STATE, TECH
	data = {
		typeID       = 1011700, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
			...
			parts={
				{
					...
					position  = { -8*.1/scaleConst, 0, -1*.1/scaleConst },    	-- float3: XYZ Relative local position of this object. Copy positions from Blender to help you out. NOTICE: Blender uses +Z as up, but this is converted to +Y (is up) when used in game.
					rotation  = { 0, -90, 0 },        			-- float3: XYZ Eular Angles, will apply rotation ZXY. Relative local rotation of this object.
					scale 	= { .1/scaleConst, .1/scaleConst, .1/scaleConst },	--stop z-fighting today!				-- float3: XYZ The nonuniform scale of the part, relative to it's parent's scale.
					parts = {
						{
							name      = "Hangar",
				...
				},
				{
					...
					mesh      = "Hangar/Hangar",
					materials = { "arc_hull_dark", "arc_teamGlow", "arc_teamColour", },
					position  = { -8*.1/scaleConst, 0, -2.75*.1/scaleConst },    	-- float3: XYZ Relative local position of this object. Copy positions from Blender to help you out. NOTICE: Blender uses +Z as up, but this is converted to +Y (is up) when used in game.
					rotation  = { 0, -90, 0 },        			-- float3: XYZ Eular Angles, will apply rotation ZXY. Relative local rotation of this object.
					scale 	= { .1/scaleConst, .1/scaleConst, .1/scaleConst },	--stop z-fighting today!				-- float3: XYZ The nonuniform scale of the part, relative to it's parent's scale.
					parts = {
						{
				...
				},
				{
					...
					mesh      = "Hangar/Hangar",
					materials = { "arc_hull_dark", "arc_teamGlow", "arc_teamColour", },
					position  = { -8*.1/scaleConst, 0, -4.5*.1/scaleConst },    	-- float3: XYZ Relative local position of this object. Copy positions from Blender to help you out. NOTICE: Blender uses +Z as up, but this is converted to +Y (is up) when used in game.
					rotation  = { 0, -90, 0 },        			-- float3: XYZ Eular Angles, will apply rotation ZXY. Relative local rotation of this object.
					scale 	= { .1/scaleConst, .1/scaleConst, .1/scaleConst },	--stop z-fighting today!				-- float3: XYZ The nonuniform scale of the part, relative to it's parent's scale.
					parts = {
						{
				...
				},
				{
					...
					mesh      = "Hangar/Hangar",
					materials = { "arc_hull_dark", "arc_teamGlow", "arc_teamColour", },
					position  = { -8*.1/scaleConst, 0, -6.25*.1/scaleConst },    	-- float3: XYZ Relative local position of this object. Copy positions from Blender to help you out. NOTICE: Blender uses +Z as up, but this is converted to +Y (is up) when used in game.
					rotation  = { 0, -90, 0 },        			-- float3: XYZ Eular Angles, will apply rotation ZXY. Relative local rotation of this object.
					scale 	= { .1/scaleConst, .1/scaleConst, .1/scaleConst },	--stop z-fighting today!				-- float3: XYZ The nonuniform scale of the part, relative to it's parent's scale.
					parts = {
						{
				...
				},
				{
					...
					mesh      = "Hangar/Hangar",
					materials = { "arc_hull_dark", "arc_teamGlow", "arc_teamColour", },
					position  = { -8*.1/scaleConst, 0, -9.25*.1/scaleConst },    	-- float3: XYZ Relative local position of this object. Copy positions from Blender to help you out. NOTICE: Blender uses +Z as up, but this is converted to +Y (is up) when used in game.
					rotation  = { 0, -90, 0 },        			-- float3: XYZ Eular Angles, will apply rotation ZXY. Relative local rotation of this object.
					scale 	= { 3*.1/scaleConst, 3*.1/scaleConst, 3*.1/scaleConst },	--stop z-fighting today!				-- float3: XYZ The nonuniform scale of the part, relative to it's parent's scale.
					parts = {
						{
							name      = "Hangar",
							position  = { 0, 0, -1.5 },    	-- float3: XYZ Relative local position of this object. Copy positions from Blender to help you out. NOTICE: Blender uses +Z as up, but this is converted to +Y (is up) when used in game.
							...
							weapon    = {
								weaponID = 1015601, --int: The weaponData id to be used for this weapon.
								turnSpeed = 0, 	--float: Degrees per second.
								turnMode = "Linear", --string enum: Linear / Acceleration
								turnInstant = false, --bool: Ignore turn speed, snap to target. (Beam Spire, point defence)
								mountAngles = { -- Weapon's firing angles in degrees. Won't aquire targets outside this field of view.
				...
				},
				{
					...
					mesh      = "Hangar/Hangar",
					materials = { "arc_hull_dark", "arc_teamGlow", "arc_teamColour", },
					position  = { -8*.1/scaleConst, 0, -12.25*.1/scaleConst },    	-- float3: XYZ Relative local position of this object. Copy positions from Blender to help you out. NOTICE: Blender uses +Z as up, but this is converted to +Y (is up) when used in game.
					rotation  = { 0, -90, 0 },        			-- float3: XYZ Eular Angles, will apply rotation ZXY. Relative local rotation of this object.
					scale 	= { .1/scaleConst, .1/scaleConst, .1/scaleConst },	--stop z-fighting today!				-- float3: XYZ The nonuniform scale of the part, relative to it's parent's scale.
					parts = {
						{
				...
				},
				{
					...
					mesh      = "Hangar/Hangar",
					materials = { "arc_hull_dark", "arc_teamGlow", "arc_teamColour", },
					position  = { -8*.1/scaleConst, 0, -14*.1/scaleConst },    	-- float3: XYZ Relative local position of this object. Copy positions from Blender to help you out. NOTICE: Blender uses +Z as up, but this is converted to +Y (is up) when used in game.
					rotation  = { 0, -90, 0 },        			-- float3: XYZ Eular Angles, will apply rotation ZXY. Relative local rotation of this object.
					scale 	= { .1/scaleConst, .1/scaleConst, .1/scaleConst },	--stop z-fighting today!				-- float3: XYZ The nonuniform scale of the part, relative to it's parent's scale.
					parts = {
						{
				...
				},
				{
					...
					mesh      = "Hangar/Hangar",
					materials = { "arc_hull_dark", "arc_teamGlow", "arc_teamColour", },
					position  = { -8*.1/scaleConst, 0, -15.75*.1/scaleConst },    	-- float3: XYZ Relative local position of this object. Copy positions from Blender to help you out. NOTICE: Blender uses +Z as up, but this is converted to +Y (is up) when used in game.
					rotation  = { 0, -90, 0 },        			-- float3: XYZ Eular Angles, will apply rotation ZXY. Relative local rotation of this object.
					scale 	= { .1/scaleConst, .1/scaleConst, .1/scaleConst },	--stop z-fighting today!				-- float3: XYZ The nonuniform scale of the part, relative to it's parent's scale.
					parts = {
						{
				...
				},
				{
					...
					mesh      = "Hangar/Hangar",
					materials = { "arc_hull_dark", "arc_teamGlow", "arc_teamColour", },
					position  = { -8*.1/scaleConst, 0, -17.5*.1/scaleConst },    	-- float3: XYZ Relative local position of this object. Copy positions from Blender to help you out. NOTICE: Blender uses +Z as up, but this is converted to +Y (is up) when used in game.
					rotation  = { 0, -90, 0 },        			-- float3: XYZ Eular Angles, will apply rotation ZXY. Relative local rotation of this object.
					scale 	= { .1/scaleConst, .1/scaleConst, .1/scaleConst },	--stop z-fighting today!				-- float3: XYZ The nonuniform scale of the part, relative to it's parent's scale.
					parts = {
						{
				...
				{
					name     = "Thruster",
					position = { 0, 0, -35.25*.1/scaleConst },
					rotation = { 0, 0, 0 },
					...
					parts = {
						...
						},
						{
							...
							mesh     = "Thruster/Thruster-Plume",
							materials  = { "arc_thruster-inner", "arc_thruster-middle", "arc_thruster-outer" },
							position = { -5, 0, 0 }, --XYZ, Thruster subparts should all be on the same Y point, as they all scale along the parent's Y axis.
							rotation = { 0, 0, 0 },
							scale 	= { 6.5, 6.5, 6.5 },
						},
						{
						...
						},
						{
							...
							mesh     = "Thruster/Thruster-Plume",
							materials  = { "arc_thruster-inner", "arc_thruster-middle", "arc_thruster-outer" },
							position = { 0, 4.5, 0 }, --XYZ, Thruster subparts should all be on the same Y point, as they all scale along the parent's Y axis.
							rotation = { 0, 0, 0 },
							scale 	= { 5, 5, 5 },
						},
						{
		...
		prefab.weapon.laser.T(
			{ 0, 0, 21.5*.1/scaleConst },
			{ 0, 0, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			false
		),
		prefab.weapon.cannon.L(
			{ 0, 4.75*.1/scaleConst, 13*.1/scaleConst },
			{ 0, 0, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.cannon.L(
			{ 0, 5.75*.1/scaleConst, 4.75*.1/scaleConst },
			{ 0, 0, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.lightning.L(
			{ -5.75*.1/scaleConst, 3.25*.1/scaleConst, 4.75*.1/scaleConst },
			{ 0, 0, 45 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.railgun.L(
			{ 0, 6.75*.1/scaleConst, -2.25*.1/scaleConst },
			{ 0, 0, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.railgun.L(
			{ 0, 7.75*.1/scaleConst, -9.25*.1/scaleConst },
			{ 0, 0, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.laser.M(
			{ -4*.1/scaleConst, 6.75*.1/scaleConst, -9.25*.1/scaleConst },
			{ 0, 0, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.laser.S(
			{ -7.25*.1/scaleConst, 3.75*.1/scaleConst, -9.25*.1/scaleConst },
			{ 0, 0, 45 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.hls.L(
			{ -1.25*.1/scaleConst, 6.75*.1/scaleConst, -22*.1/scaleConst },
			{ 0, 0, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.hls.L(
			{ -1.25*.1/scaleConst, 6.75*.1/scaleConst, -27*.1/scaleConst },
			{ 0, 0, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.hls.L(
			{ -1.25*.1/scaleConst, 6.75*.1/scaleConst, -32*.1/scaleConst },
			{ 0, 0, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.vls.L(
			{ -6.25*.1/scaleConst, 2.75*.1/scaleConst, -27*.1/scaleConst },
			{ -45, -90, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.vls.L(
			{ -5.25*.1/scaleConst, 3.75*.1/scaleConst, -27*.1/scaleConst },
			{ -45, -90, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.vls.L(
			{ -4.25*.1/scaleConst, 4.75*.1/scaleConst, -27*.1/scaleConst },
			{ -45, -90, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.vls.L(
			{ -6.25*.1/scaleConst, 2.75*.1/scaleConst, -22*.1/scaleConst },
			{ -45, -90, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.vls.L(
			{ -5.25*.1/scaleConst, 3.75*.1/scaleConst, -22*.1/scaleConst },
			{ -45, -90, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.vls.L(
			{ -4.25*.1/scaleConst, 4.75*.1/scaleConst, -22*.1/scaleConst },
			{ -45, -90, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.vls.L(
			{ -6.25*.1/scaleConst, 2.75*.1/scaleConst, -32*.1/scaleConst },
			{ -45, -90, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.vls.L(
			{ -5.25*.1/scaleConst, 3.75*.1/scaleConst, -32*.1/scaleConst },
			{ -45, -90, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
		...
		prefab.weapon.missile.vls.L(
			{ -4.25*.1/scaleConst, 4.75*.1/scaleConst, -32*.1/scaleConst },
			{ -45, -90, 0 },
			{ .1/scaleConst, .1/scaleConst, .1/scaleConst },
			isGhost
		),
	...
	health = {
		...
		health =  healthStats.baseHealth.C * functions.averageMultiplier({healthStats.healthMult.B}),              -- float: Health, also the unit's heat capacity.
		...
		armour = functions.floor(healthStats.baseArmor.C * functions.averageMultiplier({healthStats.armorMult.B})),
	...
	movement           = {
		...
		acceleration = 0.05,               -- float: The units per second of the ship's acceleration. A tolly is 0.4 units long, and accelerates at 0.35
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["T"] * weaponStats.laser.baseRange-1,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["L"] * weaponStats.missile.baseRange,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
