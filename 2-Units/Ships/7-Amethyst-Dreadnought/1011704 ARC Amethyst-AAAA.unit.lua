...
return {
	...
	parts = {
		...
		prefab.ship.amethyst.stern.A(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.amethyst.core.A(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.amethyst.bow.A(scaleConst, true, 0, "arc_aegis"),
	},
