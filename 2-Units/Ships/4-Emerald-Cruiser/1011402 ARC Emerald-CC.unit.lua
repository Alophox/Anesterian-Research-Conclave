...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_emerald-cc",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_emerald-cc.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.emerald.bow.C(scaleConst, true, 0, "arc_aegis"),
	},
	...
	health = {
		...
		health = (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.C,healthStats.healthMult.C}),
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.C,healthStats.healthMult.C}), 			-- float: Game will automatically determine, but can be manually set here.
	...
	movement           = {
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["S"] * weaponStats.hangar.baseRange,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["S"] * weaponStats.hangar.baseRange-2,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
