...
return {
	...
	movement           = {
		...
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["S"] * weaponStats.hangar.baseRange-1,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
