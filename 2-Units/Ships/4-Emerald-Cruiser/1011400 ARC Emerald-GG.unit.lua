...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_emerald-gg",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_emerald-gg.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.emerald.stern.G(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.emerald.bow.G(scaleConst, true, 0, "arc_aegis"),
	},
