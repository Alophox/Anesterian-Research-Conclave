...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329_MT_arc_emerald-gg",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "329_MT_arc_emerald-gg.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	-- mainMesh                    	= "3-Topaz/Topaz-Core-P",   -- string: Visual body of this unit. Requires materials to be visible. FileName/ObjectName, looks for FileName.glb and then ObjectName from within that.
	...
	parts = {
		...
		prefab.ship.emerald.stern.G(scaleConst,true, 0, "aegis"),
		prefab.ship.emerald.bow.G(scaleConst,true, 0, "aegis"),
	},
	...
	health = {
		...
		health = (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.G,healthStats.healthMult.G}),
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.G,healthStats.healthMult.G}), 			-- float: Game will automatically determine, but can be manually set here.
	...
	movement           = {
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["S"] * weaponStats.lightning.baseRange,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
