...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329_MT_arc_emerald-aa",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "329_MT_arc_emerald-aa.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.emerald.stern.A(scaleConst,true, 0, "aegis"),
		prefab.ship.emerald.bow.A(scaleConst,true, 0, "aegis"),
	},
	...
	health = {
		...
		health = (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.A,healthStats.healthMult.A}),
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.A,healthStats.healthMult.A}), 			-- float: Game will automatically determine, but can be manually set here.
