...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_emerald-aa",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_emerald-aa.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.emerald.stern.A(scaleConst, true, 0, "arc_aegis"),
		prefab.ship.emerald.bow.A(scaleConst, true, 0, "arc_aegis"),
	},
