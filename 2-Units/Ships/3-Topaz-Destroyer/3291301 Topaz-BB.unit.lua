...
return {
	...
	movement           = {
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["S"] * weaponStats.cannon.baseRange,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
