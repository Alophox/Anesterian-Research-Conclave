...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_topaz-mm",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_topaz-mm.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.topaz.bow.M(scaleConst, true, 0, "arc_aegis"),
	},
	...
	health = {
		...
		health = (1 - healthStats.proportionRegenMax) * healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.M,healthStats.healthMult.M}),
		...
		aegisMaximum = healthStats.proportionRegenMax *  healthStats.baseHealth[shipConst.class] * functions.averageMultiplier({healthStats.healthMult.M,healthStats.healthMult.M}), 			-- float: Game will automatically determine, but can be manually set here.
	...
	movement           = {
		...
		standoffDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["M"] * weaponStats.missile.baseRange-2,              -- float: How far away from a target's ColliderDimensions should a unit hold position?
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["M"] * weaponStats.missile.baseRange-5,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
