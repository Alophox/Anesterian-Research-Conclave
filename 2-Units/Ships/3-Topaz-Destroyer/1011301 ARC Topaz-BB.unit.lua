...
return {
	...
	data = {
		typeID       = 1011301, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	ghostParts 	= {
		prefab.ship.topaz.stern.B(scaleConst, true),
		prefab.ship.topaz.bow.B(scaleConst, true),
	},
