...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_topaz-bb",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_topaz-bb.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.topaz.bow.B(scaleConst, true, 0, "arc_aegis"),
	},
