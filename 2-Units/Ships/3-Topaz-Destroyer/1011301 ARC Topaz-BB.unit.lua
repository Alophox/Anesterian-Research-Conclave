...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329_MT_arc_topaz-bb",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "329_MT_arc_topaz-bb.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	-- BODY SETUP
	scale = scaleConst,
	-- mainMesh                    	= "3-Topaz/Topaz-Core-B",   -- string: Visual body of this unit. Requires materials to be visible. FileName/ObjectName, looks for FileName.glb and then ObjectName from within that.
