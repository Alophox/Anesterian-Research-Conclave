...
return {
	...
	movement           = {
		...
		retreatDistance = weaponStats.fireRangeMult * weaponStats.rangeMult["M"] * weaponStats.laser.baseRange-2,               -- float: How far away from a target's ColliderDimensions should a unit begin to retreat?
