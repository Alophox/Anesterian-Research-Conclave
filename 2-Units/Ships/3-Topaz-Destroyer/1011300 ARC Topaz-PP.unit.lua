...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_topaz-pp",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_topaz-pp.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	health = {
		...
		health = healthStats.baseHealth.M * functions.averageMultiplier({healthStats.healthMult.P,healthStats.healthMult.P}),
		health_regen_per_second = healthStats.regen.M,
		max_regen_frac = healthStats.proportionRegenMax,

		armour = functions.floor(healthStats.baseArmor.M * functions.averageMultiplier({healthStats.armorMult.P,healthStats.armorMult.P})),
		vulnerability_max = 0,
		shredMultiplier = 1.0,
	...
	movement           = {
		...
		acceleration = 0.22 * functions.averageMultiplier({healthStats.accelMult.P,healthStats.accelMult.P}),               -- float: The units per second of the ship's acceleration. A tolly is 0.4 units long, and accelerates at 0.35
