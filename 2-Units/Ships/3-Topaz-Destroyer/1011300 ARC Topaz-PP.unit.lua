...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329_MT_arc_topaz-pp",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "329_MT_arc_topaz-pp.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	parts = {
		...
		prefab.ship.topaz.stern.P(scaleConst,true, 0, "aegis"),
		prefab.ship.topaz.bow.P(scaleConst,true, 0, "aegis"),
	},
