...
return {
	...
	-- BODY SETUP
	scale                       = 2.8, -- 0.035714
	mainMesh                    = "329-Coheser/Coheser-3",
	...
	health = {
		...
		health = math.floor((1 - healthStats.proportionRegenMax) * 2000),
	...
	resourceGeneration = {
		...
		energy = .1, 	-- float: Energy generation per second
