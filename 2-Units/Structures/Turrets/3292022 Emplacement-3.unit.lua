...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-emplacement-l",              	-- Internal name for debugging and errors.
	...
	picture                     = "329-emplacement-l.png",            -- The name of the image file in this folder to be used for this unit.
	...
	data                        = {
		typeID       = 3292022, 	--!!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	health = {
		...
		health = functions.floor((1 - healthStats.proportionRegenMax) * 6000),
		health_regen_per_second = healthStats.regen.C,
		max_regen_frac = 0,
		aegis_regen_per_second = 1.5*healthStats.aegisRegen.C * healthStats.structAegisRegenMult,
		aegisMaximum = functions.ceil(healthStats.proportionRegenMax * 6000),
