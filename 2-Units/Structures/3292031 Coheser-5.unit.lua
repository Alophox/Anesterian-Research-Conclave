...
return {
	...
	-- BODY SETUP
	scale                       = 4.8, -- 0.020833
	mainMesh                    = "329-Coheser/Coheser-5",
	...
	health = {
		...
		health = functions.floor((1 - healthStats.proportionRegenMax) * 5000),
		...
		aegisMaximum = functions.ceil(healthStats.proportionRegenMax * 5000),
