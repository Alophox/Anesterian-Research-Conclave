...
return {
	...
	health = {
		...
		health = functions.floor(1),              -- float: Health, also the unit's heat capacity.
		...
		aegisMaximum = functions.ceil(0), 			-- float: Game will automatically determine, but can be manually set here.
