...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-subspace-module",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Subspace Sensor Module",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	unitTooltip                 = "", 						   -- string: Shown when moused over in the HUD.
	unitBlurb                   = "Subspace Sensor Module", -- string: Shown just below the unit name in tooltips and databank.
	...
	data = {
		typeID       = 3297112, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
    ...
    cloakDetector = {
        range = weaponStats.sensor.baseRange * weaponStats.rangeMult.L, -- float - distance at which cloaked enemy units will be revealed
