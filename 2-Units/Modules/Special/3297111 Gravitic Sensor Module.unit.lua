...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-gravitic-module",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Gravitic Sensor Module",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	unitTooltip                 = "", 						   -- string: Shown when moused over in the HUD.
	unitBlurb                   = "Gravitic Sensor Module", -- string: Shown just below the unit name in tooltips and databank.
	...
	data = {
		typeID       = 3297111, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
