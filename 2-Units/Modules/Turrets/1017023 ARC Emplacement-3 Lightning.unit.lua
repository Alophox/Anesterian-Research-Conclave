...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_emplacement_3-lightning",              	-- Internal name for debugging and errors.
	...
	picture                     = "arc_emplacement_3-lightning.png",            -- The name of the image file in this folder to be used for this unit.
