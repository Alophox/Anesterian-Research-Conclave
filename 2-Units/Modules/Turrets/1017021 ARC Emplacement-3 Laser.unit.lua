...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_emplacement_3-laser",              	-- Internal name for debugging and errors.
	...
	picture                     = "arc_emplacement_3-laser.png",            -- The name of the image file in this folder to be used for this unit.
	...
	data                        = {
		typeID       = 1017021, 	--!!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
