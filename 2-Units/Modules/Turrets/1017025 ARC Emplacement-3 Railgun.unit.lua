...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329_MT_arc_emplacement_3-railgun",              	-- Internal name for debugging and errors.
	...
	picture                     = "329_MT_arc_emplacement_3-railgun.png",            -- The name of the image file in this folder to be used for this unit.
