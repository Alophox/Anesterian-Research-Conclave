...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-emplacement_3-lightning",              	-- Internal name for debugging and errors.
	unitDisplayName             = "Large Emplacement-Breach Cannon",                    	-- Actual display name of the unit in the Databank, HUD, etc.
	...
	-- picture                     = "329-emplacement_3-lightning.png",            -- The name of the image file in this folder to be used for this unit.
	...
	databankEntry               = {
		...
		weaponInfo                  = functions.combineWeaponInfo({
			prefab.weapon_info.module.emplacement.L(8, "lightning"),
		}),
	...
	unitMetaRole = {
        defenceRole = "HEAVY_ARMOUR, CAPITAL_ARMOUR", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what adaptive AIs think this unit is good at defending against. Multiple roles may be assigned
        offenceRole = "IGNORE", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what adaptive AIs think this unit is good at attacking. Multiple roles may be assigned
        defenceResponse = "IGNORE", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what defenses adaptive AIs think they should counter this unit with. Multiple roles may be assigned
        offenceResponse = "HEAVY", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what ships adaptive AIs think they should counter this unit with. Multiple roles may be assigned
        dangerDistance = weaponStats.rangeMult["L"] * weaponStats.lightning.baseRange, -- float - distance at which adaptive AIs will consider this unit to be a threat and factor it into their threat heatmaps. Pretty sure this doesn't affect the distance at which said AIs will react to it though, since that's a separate parameter that the AI itself uses
	...
	colliderDimensions = {
		widthMultiplier  = .8, --Multiplied by scale to determine the percieved width of the unit. Long units (Vaalkorei) have this at about 0.5~0.6, aka we're only half as wide as we are long.
		...
		lengthMultiplier = .8, --Multiplied by scale to determine the percieved length of the unit. wide units (Soul Warden Fore section) have this at about 0.5, aka we're only half as long as we are wide.
	},

	-- 🟦 UNIT ID, STRUCTURE COST, MACROTARGET STATE, TECH
	data                        = {
		typeID       = 3297023, 	--!!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
		...
		cost_time    = 5, 		--integer, For structures, how long in seconds it takes to build.
		techRequired = 0
	},

	displayAreaRadius        = weaponStats.lightning.baseRange * weaponStats.rangeMult.L,            -- decimal
    displayAreaColour        = { 1,0,0,.2 },  -- decimals

	-- 🟦 PARTS
	parts = {
		prefab.part.module.emplacement.L(scaleConst, 1, "lightning", false),
		prefab.part.module.emplacement.L(scaleConst, 3, "lightning", false),
		prefab.part.module.emplacement.L(scaleConst, 5, "lightning", false),
		prefab.part.module.emplacement.L(scaleConst, 7, "lightning", false),
		prefab.part.module.emplacement.L(scaleConst, 9, "lightning", false),
		prefab.part.module.emplacement.L(scaleConst, 11, "lightning", false),
		prefab.part.module.emplacement.L(scaleConst, 13, "lightning", false),
		prefab.part.module.emplacement.L(scaleConst, 15, "lightning", false),
	},

	ghostParts = {
		prefab.part.module.emplacement.L(scaleConst, 1, "lightning", true),
		prefab.part.module.emplacement.L(scaleConst, 3, "lightning", true),
		prefab.part.module.emplacement.L(scaleConst, 5, "lightning", true),
		prefab.part.module.emplacement.L(scaleConst, 7, "lightning", true),
		prefab.part.module.emplacement.L(scaleConst, 9, "lightning", true),
		prefab.part.module.emplacement.L(scaleConst, 11, "lightning", true),
		prefab.part.module.emplacement.L(scaleConst, 13, "lightning", true),
		prefab.part.module.emplacement.L(scaleConst, 15, "lightning", true),
	},
