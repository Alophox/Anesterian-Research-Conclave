...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-emplacement_3-missile",              	-- Internal name for debugging and errors.
	unitDisplayName             = "Large Emplacement-Missile",                    	-- Actual display name of the unit in the Databank, HUD, etc.
	...
	-- picture                     = "329-emplacement_3-missile.png",            -- The name of the image file in this folder to be used for this unit.
	...
	databankEntry               = {
		...
		weaponInfo                  = functions.combineWeaponInfo({
			prefab.weapon_info.module.emplacement.missile.L(8, "vls"),
		}),
	...
	unitMetaRole = {
        defenceRole = "LIGHT, MEDIUM, MEDIUM_STANDOFF, HEAVY", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what adaptive AIs think this unit is good at defending against. Multiple roles may be assigned
	...
	data                        = {
		typeID       = 3297020, 	--!!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	-- 🟦 PARTS
	parts = {
		prefab.part.module.emplacement.missile.L(scaleConst, 1, "vls", false),
		prefab.part.module.emplacement.missile.L(scaleConst, 3, "vls", false),
		prefab.part.module.emplacement.missile.L(scaleConst, 5, "vls", false),
		prefab.part.module.emplacement.missile.L(scaleConst, 7, "vls", false),
		prefab.part.module.emplacement.missile.L(scaleConst, 9, "vls", false),
		prefab.part.module.emplacement.missile.L(scaleConst, 11, "vls", false),
		prefab.part.module.emplacement.missile.L(scaleConst, 13, "vls", false),
		prefab.part.module.emplacement.missile.L(scaleConst, 15, "vls", false),
	},

	ghostParts = {
		prefab.part.module.emplacement.missile.L(scaleConst, 1, "vls", true),
		prefab.part.module.emplacement.missile.L(scaleConst, 3, "vls", true),
		prefab.part.module.emplacement.missile.L(scaleConst, 5, "vls", true),
		prefab.part.module.emplacement.missile.L(scaleConst, 7, "vls", true),
		prefab.part.module.emplacement.missile.L(scaleConst, 9, "vls", true),
		prefab.part.module.emplacement.missile.L(scaleConst, 11, "vls", true),
		prefab.part.module.emplacement.missile.L(scaleConst, 13, "vls", true),
		prefab.part.module.emplacement.missile.L(scaleConst, 15, "vls", true),
	},
