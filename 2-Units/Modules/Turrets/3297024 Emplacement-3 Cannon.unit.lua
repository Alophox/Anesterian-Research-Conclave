...
return {
	...
	unitDisplayName             = "Large Emplacement-Neutron Launcher",                    	-- Actual display name of the unit in the Databank, HUD, etc.
	...
	databankEntry               = {
		...
		weaponInfo                  = functions.combineWeaponInfo({
			prefab.weapon_info.module.emplacement.L(8, "cannon"),
		}),
	...
	unitMetaRole = {
        defenceRole = "LIGHT, LIGHT_ARMOUR, MEDIUM, HEAVY", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what adaptive AIs think this unit is good at defending against. Multiple roles may be assigned
	...
	data                        = {
		typeID       = 3297024, 	--!!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	displayAreaRadius        = weaponStats.cannon.baseRange * weaponStats.rangeMult.L,            -- decimal
    displayAreaColour        = { 1,0,0,.2 },  -- decimals

	-- 🟦 PARTS
	parts = {
		prefab.part.module.emplacement.L(scaleConst, 1, "cannon", false),
		prefab.part.module.emplacement.L(scaleConst, 3, "cannon", false),
		prefab.part.module.emplacement.L(scaleConst, 5, "cannon", false),
		prefab.part.module.emplacement.L(scaleConst, 7, "cannon", false),
		prefab.part.module.emplacement.L(scaleConst, 9, "cannon", false),
		prefab.part.module.emplacement.L(scaleConst, 11, "cannon", false),
		prefab.part.module.emplacement.L(scaleConst, 13, "cannon", false),
		prefab.part.module.emplacement.L(scaleConst, 15, "cannon", false),
	},

	ghostParts = {
		prefab.part.module.emplacement.L(scaleConst, 1, "cannon", true),
		prefab.part.module.emplacement.L(scaleConst, 3, "cannon", true),
		prefab.part.module.emplacement.L(scaleConst, 5, "cannon", true),
		prefab.part.module.emplacement.L(scaleConst, 7, "cannon", true),
		prefab.part.module.emplacement.L(scaleConst, 9, "cannon", true),
		prefab.part.module.emplacement.L(scaleConst, 11, "cannon", true),
		prefab.part.module.emplacement.L(scaleConst, 13, "cannon", true),
		prefab.part.module.emplacement.L(scaleConst, 15, "cannon", true),
	},
