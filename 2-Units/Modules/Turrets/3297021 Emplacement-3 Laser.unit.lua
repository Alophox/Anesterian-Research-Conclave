...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-emplacement_3-laser",              	-- Internal name for debugging and errors.
	unitDisplayName             = "Large Emplacement-Laser",                    	-- Actual display name of the unit in the Databank, HUD, etc.
	...
	-- picture                     = "329-emplacement_3-laser.png",            -- The name of the image file in this folder to be used for this unit.
	...
	databankEntry               = {
		...
		weaponInfo                  = functions.combineWeaponInfo({
			prefab.weapon_info.module.emplacement.L(8, "laser"),
		}),
	...
	unitMetaRole = {
        defenceRole = "MISSILE, DRONE, LIGHT, MEDIUM", -- enum UNITROLE - IGNORE, MISSILE, DRONE, DRONE_ARMOURED, LIGHT, LIGHT_ARMOUR, MEDIUM, MEDIUM_ARMOUR, MEDIUM_STANDOFF, HEAVY, HEAVY_ARMOUR, HEAVY_STANDOFF, CAPITAL, CAPITAL_ARMOUR, CAPITAL_STANDOFF, TITAN. Determines what adaptive AIs think this unit is good at defending against. Multiple roles may be assigned
	...
	data                        = {
		typeID       = 3297021, 	--!!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
		...
		prefab.part.module.emplacement.L(scaleConst, 3, "laser", false),
		prefab.part.module.emplacement.L(scaleConst, 5, "laser", false),
		prefab.part.module.emplacement.L(scaleConst, 7, "laser", false),
		prefab.part.module.emplacement.L(scaleConst, 9, "laser", false),
		prefab.part.module.emplacement.L(scaleConst, 11, "laser", false),
		prefab.part.module.emplacement.L(scaleConst, 13, "laser", false),
		prefab.part.module.emplacement.L(scaleConst, 15, "laser", false),
	},

	ghostParts = {
		prefab.part.module.emplacement.L(scaleConst, 1, "laser", true),
		prefab.part.module.emplacement.L(scaleConst, 3, "laser", true),
		prefab.part.module.emplacement.L(scaleConst, 5, "laser", true),
		prefab.part.module.emplacement.L(scaleConst, 7, "laser", true),
		prefab.part.module.emplacement.L(scaleConst, 9, "laser", true),
		prefab.part.module.emplacement.L(scaleConst, 11, "laser", true),
		prefab.part.module.emplacement.L(scaleConst, 13, "laser", true),
		prefab.part.module.emplacement.L(scaleConst, 15, "laser", true),
	},
