...
- Plasma Railgun: Kontaalen Plasma damage/heat + Vaalkorai Railgun speed.

Balance is intended to be Vanilla. If it is not, suggestions are welcome. I do not foresee this being entirely balanced correctly at first, given the relatively low sample size Platform Wars and my own testing can provide. 
