...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-lancier-budget",                 -- string: Internal name for debugging and errors.
	...
	parts = {
		{
			name = "circle",
			mesh = "329-Turrets-Experimental/TwistedTorus",
					...
					parts = {
						{
							...
							parts={
								{
									name="shooty bit",
								--	mesh      = "329-Turrets-1/Turret-1-Laser", --The mesh to be used for this part, works the same as mainMesh.
									...
									parts={
										...
										{
											name		 = "Turret Laser",
											mesh       = "329-Turrets-1/Turret-1-Laser-Effect",
											materials  = { "329_MT_arc_teamGlow" },
											position   = { 0, 0, 0 },
											rotation   = { 0, 0, 0 },
											scale 	 = { .1, .1, .1 },
										...
										{
											name = "Turret Laser",mesh = "329-Turrets-1/Muzzle-Flash",	materials = { "329_MT_arc_teamGlow" },	position   = { 0, 0, 0 }, rotation   = { 0, 0, 0 },	scale 	 = { 1, 1, 1 },
