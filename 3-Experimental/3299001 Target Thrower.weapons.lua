return {
	...
	weapon = {
		...
		spreadDegrees = 1.14,          -- Radians, spread for LAUNCHER (machine guns, etc)
	...
	targeting = {
		...
		tracking = {
			...
			predictionVelocityOveride = 10, 	--The speed of the thing we want to hit our target with. For bullets use unitsPerSecond. EG. An Untresnafol has this set to the launch velocity of it's bullet.
