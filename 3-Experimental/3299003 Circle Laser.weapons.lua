return {
	...
	weapon = {
		...
		maximumAngleToTargetDegrees = 286.47889756541161,   -- Radians, target must be within angle for gun to fire.
		...
		lasersPerShot = 2, --How many "weaponVisualConfig parts" to use at once. For having multiple laser/muzzle effects at the same time. (reminder that each WVC can define it's own laserDescription)
	...
	targeting = {
		acquisition = {
			...
			maximumAngleDegrees = 286.47889756541161, 				--Good for spinal weapons/missiles.
