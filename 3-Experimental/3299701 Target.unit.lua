...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-target",                 -- string: Internal name for debugging and errors.
	unitDisplayName             = "Target",                         -- string: Actual display name of the unit in the Databank, HUD, etc.
	unitTooltip                 = "", 						   -- string: Shown when moused over in the HUD.
	unitBlurb                   = "For use with jank", -- string: Shown just below the unit name in tooltips and databank.
	...
	-- picture                     = "329-target.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	data = {
		typeID       = 3299701, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	health = {
		...
		unkillable = true,                   	-- Even in death, I am eternal.
