...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329_MT_arc_vulpes",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "329_MT_arc_vulpes.png",             -- string filename: The name of the image file in this folder to be used for this unit.
	...
	data = {
		typeID       = 3293015, -- int: !!! IMPORTANT !!! The unique id of this unit. Must be higher than 99999 (ATS reserved). Used by maps and many things. If you change this any maps made with it won't be able to find the unit and will just spawn nothing.
	...
	parts = {
		...
		},
		{
			...
			weapon    = {
				weaponID = 3293016, --int: The weaponData id to be used for this weapon.
