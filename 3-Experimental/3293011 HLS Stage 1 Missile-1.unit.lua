...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329-zerda-e",                 -- string: Internal name for debugging and errors.
	...
	parts = {
		{
			name	= "Model",
			mesh      = "329-Missiles/Missile-1-Zerda",
			materials = { "329_MT_arc_hull","329_MT_arc_teamColour","329_MT_arc_engine","329_MT_arc_hull_dark","329_MT_arc_teamGlow" },
	...
	movement           = {
		...
		maximumAngleToTargetDegrees = 28.647889756541161,        -- float: Radians within in which a unit is allowed to accelerate towards a target.
