...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_zerda",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_zerda.png",             -- string filename: The name of the image file in this folder to be used for this unit.
