...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "arc_target",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "arc_target.png",             -- string filename: The name of the image file in this folder to be used for this unit.
