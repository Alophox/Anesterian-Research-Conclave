...
return {
	...
	-- 🟦 DEFINITIONS
	unitName                    = "329_MT_arc_target",                 -- string: Internal name for debugging and errors.
	...
	picture                     = "329_MT_arc_target.png",             -- string filename: The name of the image file in this folder to be used for this unit.
