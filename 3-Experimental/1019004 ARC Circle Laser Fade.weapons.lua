return {
	...
	weapon = {
		...
		damageData = {
			...
			piercing = 3,                      -- float: Ignore this much armour. Negative piercing is AEGIS shielding.
		...
		laserDescription = { 		--"laser" description, but is actually a maleable visual effect.
						duration = 1,			--seconds
						opacity = 1,			--float, 0-1
						diameter = .35,			--relative to turret scale
	...
	targeting = {
		acquisition = {
			...
			secondsPerScan = 11111, 			--How long to wait before reassessing what you're targeting.
			...
			maximumDistance = 0, 			--Important. Scan radius. Don't target things further than this. KEEP THIS NUMBER LOW, SERIOUS PERFORMANCE IMPACT. Light ~15, Medium ~20, Heavy ~25, Capital ~25
			...
			scoreForDistance = 0,    		--Foundational. NOTICE, VALUE IS INVERTED. Keep at 1. 1 unit distance = -1 score, means prioritise closer targets. Negative means prioritise farther targets.
